...
public class Login extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                if (counter == maxAttempts) {
                ...
                } else if(isValid != true && counter < maxAttempts){
                    ...
                    javamail(userTextField.getText());
                    grid.setVisible(false);
    ...
    public void javamail(String user){
		...
		Session session = Session.getDefaultInstance(props,
			new javax.mail.Authenticator() {
				protected PasswordAuthentication getPasswordAuthentication() {
					return new PasswordAuthentication("hggaruckus","APPLEFTW");
				}
			});
		...
		try {
			...
			message.setFrom(new InternetAddress("hggaruckus@gmail.com"));
                        message.setRecipients(Message.RecipientType.TO,
					InternetAddress.parse("hggaruckus@gmail.com"));
			message.setSubject("Login Security Code");
			message.setText("Dear " + user + "," +
					"\n\n Thank you for attempting to login to SDEV425!"
